...
The first method works in the same way as the `addDeploymentFile` method described in the section link:deploy-program-bootstrap.md[Deploying Programmatically during Bootstrap].
